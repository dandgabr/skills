...
- Para correlacionar o CIS Control 5 e 6 aos princípios de gestão de acesso em nuvem e AD, consulte a skill [iam-access-management](../iam-access-management/SKILL.md).
- Para alinhar a segurança de software do CIS Control 16 com a validação OWASP ASVS, consulte a skill [appsec-owasp-asvs](../appsec-owasp-asvs/SKILL.md).
