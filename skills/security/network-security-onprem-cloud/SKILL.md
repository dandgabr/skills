...
- Para alinhar o uso de criptografia e suítes nos túneis IPsec, TLS 1.3, QUIC e mTLS, consulte a skill [cryptography-pqc-standards](../cryptography-pqc-standards/SKILL.md).
- Para alinhar o controle de acesso e federação de redes aos provedores de identidade IAM, consulte a skill [iam-access-management](../iam-access-management/SKILL.md).
- Para integrar a segurança de rede às matrizes de controles da Cloud Security Alliance (CCM v4 - IVS & IPY), consulte a skill [csa-cloud-security](../csa-cloud-security/SKILL.md).
...
- Para monitoramento e resposta a incidentes de rede via SIEM/SOAR e análise PCAP, consulte a skill [secops-incident-responder](../secops-incident-responder/SKILL.md).
