...
- Para adequação de criptografia e gestão de chaves aos controles organizacionais ISO/IEC 27001 (A.8.24), consulte a skill [iso-27000-series](../iso-27000-series/SKILL.md).
- Para alinhar a proteção de chaves e segredos em nuvem (AWS KMS, Azure Key Vault, GCP KMS) aos controles da CSA CCM v4 (CEK & DSP), consulte a skill [csa-cloud-security](../csa-cloud-security/SKILL.md).
- Para integrar KMS e segredos em pipelines de CI/CD e infraestrutura de containers, consulte a skill [devsecops-engineer](../devsecops-engineer/SKILL.md).
