...
- Para alinhamento dos controles tecnológicos ISO 27002 (A.8.24) às melhores práticas criptográficas e quânticas, consulte a skill [cryptography-pqc-standards](../cryptography-pqc-standards/SKILL.md).
- Para detalhamento dos controles de acesso ISO 27002 (A.5.15 a A.5.18, A.8.2 a A.8.5), consulte a skill [iam-access-management](../iam-access-management/SKILL.md).
- Para alinhamento com requisitos de nuvem específicos da CSA CCM v4, consulte a skill [csa-cloud-security](../csa-cloud-security/SKILL.md).
