...
5. **Prescrição de Remediação Limpa e Defensiva**:
   ...
   - Garanta que a solução respeite as diretrizes de código limpo da skill [clean-code-reusability](../../general/clean-code-reusability/SKILL.md).
...
- **[devsecops-engineer](../devsecops-engineer/SKILL.md)**: Configura a execução automatizada de ferramentas SAST no pipeline de CI/CD e estabelece Quality Gates.
- **[clean-code-reusability](../../general/clean-code-reusability/SKILL.md)**: Garante que as correções de segurança propostas mantenham a legibilidade, evitem redundâncias e reutilizem lógicas existentes.
