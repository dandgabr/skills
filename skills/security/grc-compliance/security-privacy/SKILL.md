...
- [software-architect](../../../roles/software-architect/SKILL.md): Apoia no desenho de arquiteturas que suportam portabilidade de dados, exclusões em cascata e pseudonimização estrutural.
...
- [backend-developer](../../../roles/backend-developer/SKILL.md): Guia na criptografia de dados em banco de dados, sanitização de logs e APIs de direitos do titular.
- [frontend-developer](../../../roles/frontend-developer/SKILL.md): Guia no gerenciamento de consentimento (banners de cookies), visibilidade de dados sensíveis na UI e segurança do lado do cliente.
