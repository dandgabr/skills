...
- Para configurar permissões de Service Principals no Entra ID para conectores do Power Automate, consulte a skill [iam-access-azure](../../security/iam-access-azure/SKILL.md).
- Para padrões de API REST e contratos OpenAPI em Custom Connectors, consulte a skill [backend-developer](../../general/backend-developer/SKILL.md).
