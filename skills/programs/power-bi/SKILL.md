...
- Para configuração de identidades e RLS no Entra ID (Azure AD), consulte a skill [iam-access-azure](../../security/iam-access-azure/SKILL.md).
- Para integração de modelos de BI com data warehouses e bancos de dados SQL, consulte a skill [backend-developer](../../general/backend-developer/SKILL.md).
