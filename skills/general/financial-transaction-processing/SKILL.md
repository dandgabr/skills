...
- Para adequação de ambiente a normas de segurança de cartões de crédito e escopo CDE, consulte a skill [pci-dss-compliance](../../security/pci-dss-compliance/SKILL.md).
- Para assinaturas digitais RSADSSA-PSS e encriptação de payloads Pix/SPB, consulte a skill [cryptography-pqc-standards](../../security/cryptography-pqc-standards/SKILL.md).
- Para desenvolvimento de APIs REST resilientes e microsserviços de pagamento, consulte a skill [backend-developer](../backend-developer/SKILL.md).
