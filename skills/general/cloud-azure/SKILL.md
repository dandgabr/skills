...
- Para políticas de Entra ID, Azure RBAC, PIM e Managed Identities, consulte a skill [iam-access-azure](../../security/iam-access-azure/SKILL.md).
- Para automação de pipelines CI/CD e gerenciamento de containers, consulte a skill [devops-engineer](../devops-engineer/SKILL.md).
- Para encriptação de discos e gestão de chaves em Azure Key Vault, consulte a skill [cryptography-pqc-standards](../../security/cryptography-pqc-standards/SKILL.md).
