...
- Para políticas de IAM do OCI, grupos dinâmicos e linguagem de políticas, consulte a skill [iam-access-oci](../../security/iam-access-oci/SKILL.md).
- Para automação de infraestrutura com Terraform e Ansible, consulte a skill [devops-engineer](../devops-engineer/SKILL.md).
- Para encriptação de volumes de bloco OCI e gestão de chaves em OCI Vault, consulte a skill [cryptography-pqc-standards](../../security/cryptography-pqc-standards/SKILL.md).
