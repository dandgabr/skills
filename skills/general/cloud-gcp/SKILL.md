...
- Para políticas de IAM no GCP, Service Account Impersonation e VPC Service Controls, consulte a skill [iam-access-gcp](../../security/iam-access-gcp/SKILL.md).
...
- Para automação de infraestrutura com Terraform e Kubernetes, consulte a skill [devops-engineer](../devops-engineer/SKILL.md).
