...
5. **Escreva Testes**: Projete testes unitários com TDD antes ou em conjunto com a escrita do código para validar a alta coesão e o baixo acoplamento do design.
