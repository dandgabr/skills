...
3. **Arquitetura e Clean Code**:
   ...
   - Garanta a não duplicação e reutilização ativa de código utilizando a skill [clean-code-reusability](skills\general\engineering-practices\clean-code-reusability\SKILL.md).
