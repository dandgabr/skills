...
# Resolve o governor relativamente a este script (portável entre PCs/harness),
# permitindo override explícito via ORCH_GOVERNOR.
SCRIPT_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]:-$0}")" && pwd)"
GOV="${ORCH_GOVERNOR:-${SCRIPT_DIR}/orchestrator-governor.sh}"
