...
| 30 | **pentester-agent** | [`AGENT.md`](pentester-agent/AGENT.md) | [`agent.yaml`](pentester-agent/agent.yaml) | [`agent.json`](pentester-agent/agent.json) | Agente Pentester Ético especializado em auditorias ofensivas (OWASP WSTG, DAST com OWASP ZAP, API Security, Cloud, LLMs e Red Team Scripting) usando utilitários CLI e scripts customizados. |
