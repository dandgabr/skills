...
| 39 | **self** | [`AGENT.md`](self/AGENT.md) | [`agent.yaml`](self/agent.yaml) | [`agent.json`](self/agent.json) | Subagente de Clonagem e Execução Paralela / Isolamento de Contexto (Self Subagent). Herda integralmente a configuração, ferramentas (leitura, escrita, execução de comandos e orquestração) e modelo do agente principal para executar subtarefas complexas em conversas independentes. |
